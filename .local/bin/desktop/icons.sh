#!/usr/bin/env bash
# Cambiar wet por curl
# Revisar la funcion que tengo de zsh para descargar fonts
set -euo pipefail
...
if [[ "$elegir_actualizar_icons" == "S" ]] || [[ ! -d ~/.local/share/icons/Bibata-Modern-Ice/ ]]; then
	sudo wget -O "$tempdir/Bibata-Modern-Ice.tar.xz" https://github.com/ful1e5/Bibata_Cursor/releases/download/v2.0.7/Bibata-Modern-Ice.tar.xz

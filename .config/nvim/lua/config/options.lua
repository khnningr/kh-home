...
-- NOTA  : En caso de tener dudas, usar :help «OPCIÓN».
-- =============================================================================
-- local opt = vim.o
-- Basic Settings
vim.opt.number = true -- Line numbers / Números de línea.
vim.opt.relativenumber = true -- Relative line numbers / Números relativos de línea.
vim.opt.cursorline =true -- Highlight current line / Resaltar la línea actual.
vim.opt.scrolloff = 10 -- Keep 10 lines above/below cursor / Desplazarse, mantener el cursor 10 líneas por encima/debajo del texto.
vim.opt.sidescrolloff = 8 -- Keep 8 columns left/right of cursor
vim.opt.wrap = false -- Don't wrap lines / Desactivar los ajustes de las líneas.
vim.opt.cmdheight = 1 -- Command line height / Altura en la parte inferior.
vim.opt.spelllang = { "en", "es" } -- Set language for spellchecking / Ortografía.

-- Tabbing (Pestañas) / Indentation
vim.opt.tabstop = 2 -- Tab width /
vim.opt.shiftwidth = 2 -- Indent width /
vim.opt.softtabstop = 2 --Soft tab stop /
vim.opt.expandtab = true -- Use spaces instead of tabs / 
vim.opt.smartindent = true -- Smart auto-indenting / Sangría automática.
...
-- Search Settings
vim.opt.ignorecase = true -- Case-insensitive search / Ignorar mayúsculas y minúsculas.
vim.opt.smartcase = true -- Case-sensitive if uppercase in search
vim.opt.hlsearch = false -- Don't highlightt search results
